...
\begin{figure}[!h]
\begin{center}
\includesvg{part01/chap07/intro02}
\end{center}
...
\begin{center}
\includesvg[scale=0.5]{part01/chap07/spectre_en_frequence}
\end{center}
...
\begin{center}
\includesvg{part01/chap07/signal_carre}
\end{center}
...
\begin{center}
\includesvg{part01/chap07/spectre_carre}
\end{center}
\end{minipage}
...
\begin{minipage}{0.4\textwidth}
\begin{center}
\includesvg{part01/chap07/E_bandefreq}
\end{center}
\end{minipage}
\begin{minipage}{0.5\textwidth}
\begin{equation}
...
& \includesvg{part01/chap07/tf_constante_t} 
& \includesvg{part01/chap07/tf_constante_f}\\ 
\hline
\multirow{2}{*}{Sinus} & $sin(2\pi\nu_0t)$ & \multirow{2}{*}{$\dfrac{1}{2j}\,(\delta(\nu-\nu_0) - \delta(\nu+\nu_0))$} \\
& \includesvg{part01/chap07/tf_sinus_t} 
& \\
\hline
\multirow{2}{*}{Cosinus} & $cos(2\pi\nu_0t)$ & $\dfrac{1}{2}\,(\delta(\nu-\nu_0) + \delta(\nu+\nu_0))$ \\
& \includesvg{part01/chap07/tf_cosinus_t} 
& \includesvg{part01/chap07/tf_cosinus_f}\\
\hline
	\multirow{2}{*}{Sinus cardinal} & $2\nu_0\,sinc(2\pi \nu_0 t)$ & $\Pi_{2\nu_0}\left(\nu\right) $ \\[2ex]
& \includesvg{part01/chap07/tf_sinus_card_t} 
& \includesvg{part01/chap07/tf_sinus_card_f}\\
\hline
\multirow{2}{*}{Dirac} & $\delta(t)$ & $1$ \\
& \includesvg{part01/chap07/tf_dirac_t} 
& \includesvg{part01/chap07/tf_dirac_f}\\
\hline
\end{tabular}
\end{center}
...
& \includesvg{part01/chap07/tf_dirac_decale_t} & \\
\hline
	\multirow{2}{*}{Exponentielle complexe} & \multirow{2}{*}{$e^{j2\pi \nu_0 t}$} & $\delta(\nu-\nu_0)$ \\
& & \includesvg{part01/chap07/tf_exponentielle_complexe_f}\\
\hline
	\multirow{2}{*}{Peigne de Dirac} & $\Sha_{T_e}(t)$ & $\dfrac{1}{T_e}\Sha_{F_e}(\nu)$ \\
& \includesvg{part01/chap07/tf_peigne_dirac_t} 
& \includesvg{part01/chap07/tf_peigne_dirac_f}\\
\hline
\multirow{2}{*}{Fonction porte} & $\Pi_{T_0}$ & $ T_0\,sinc(\pi\nu T_0)$ \\
& \includesvg{part01/chap07/tf_porte_t} 
& \includesvg{part01/chap07/tf_porte_f}\\
\hline
\end{tabular}
\end{center}
